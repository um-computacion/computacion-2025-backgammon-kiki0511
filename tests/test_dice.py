...
class TestDice(unittest.TestCase):
   ...
   # Metodos helper para hacer los tests mas legibles
   ...
   def _verificar_valores_en_rango(self, resultado):
       #Helper: verifica que todos los valores estan entre 1 y 6 
   ...
   def test_multiples_tiradas_mantienen_consistencia(self):
       #M̼ltiples tiradas deben mantener la consistencia del estado
       # Tirada normal
